...
function bravada_body_classes( $classes ) {
	...
	if ( ( $options['theme_headerfullscreen'] == 1 ) || ( ( $options['theme_headerfullscreen'] == 2 ) && is_front_page() ) ) $classes[] = 'bravada-fullscreen-headerimage';
...
?>
:root {
  --bravada-accent-1: <?php echo esc_html( $theme_accent1 ) ?>;
  --bravada-accent-2: <?php echo esc_html( $theme_accent2 ) ?>;
}

.bravada-accent-1 	 { color: <?php echo esc_html( $theme_accent1 ) ?>; }
.bravada-accent-2 	 { color: <?php echo esc_html( $theme_accent2 ) ?>; }
.bravada-accent-1-bg { background-color: <?php echo esc_html( $theme_accent1 ) ?>; }
.bravada-accent-2-bg { background-color: <?php echo esc_html( $theme_accent2 ) ?>; }
